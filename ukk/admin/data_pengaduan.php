            ...
            <tr>
                ...
                <?php 
                      ...
                      <?php }?>
                       ...
                       <?php 
                     if ($data['status'] =='proses') {?>
                      <a href="" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#tanggapi<?php echo $data['id_pengaduan'] ?>">TANGGAPI</a>
                      <!-- Modal Tanggapi -->
                      <div class="modal fade" id="tanggapi<?php echo $data['id_pengaduan'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              <button type="submit" name="kirim_tanggapan" value="Tanggapan" class="btn btn-primary">Tanggapi</button>
                            </div>
                            </form>
                            <?php 
                          if(isset($_POST['kirim_tanggapan'])){
