...
<div class="row">
        ...
        <div class="card">
            <div class="card-header">
               ...
               <div class="card-body">
               <a href="" class="btn btn-dark"data-bs-toggle="modal" data-bs-target="#tambahData"><i class="bi bi-file-plus"></i>Tambah Data Petugas</a>
                    ...
                    <table class="table table-striped">
                        ...
                        include '../config/koneksi.php';
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="" class="btn btn-danger"data-bs-toggle="modal" data-bs-target="#hapus<?php echo $data['id_petugas']?>"><i class="bi bi-trash-fill"></i></a>
                        <!-- Modal hapus-->
